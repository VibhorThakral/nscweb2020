...
getNewQuestion = () => {
    ...
    if(availableQuestions.length === 0 || questionCounter >= MAX_QUESTIONS) {
        ...
        return window.location.assign('https://vibhorthakral.github.io/nscweb2020/end.html');
    }
...
function checkPageFocus() {
    if (!document.hasFocus()) {
      ...
      window.location.assign('https://vibhorthakral.github.io/nscweb2020/terminated.html');
    }
}
